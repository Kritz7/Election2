...
if(isset($_POST['add-player']) && isset($_POST['to-room'])){
	AddPlayerToRoom($_POST['to-room'], $_POST['add-player']);
}


if(isset($_POST['remove-player']) && isset($_POST['from-room'])){
	PlayerLeaveRoom($_POST['from-room'], $_POST['remove-player']);
}

if(isset($_POST['write-name']) && isset($_POST['write-room'])
	&& isset($_POST['write-data'])){
	WriteToPlayer($_POST['write-name'], $_POST['write-room'],
		$_POST['write-data']);
}
